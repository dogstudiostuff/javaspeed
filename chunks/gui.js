...
var onClickLogo = function onClickLogo() {
  window.open('https://github.com/powerbox1000/dev-blocks/wiki');
};
...
/* harmony default export */ __webpack_exports__["default"] = (function (appTarget) {
  ...
  if (true) {
    // From https://github.com/griffpatch/Scratch3-Dev-Tools/blob/master/inject3.js
    document.head.appendChild(Object.assign(document.createElement('script'), {
      src: '/ext/griffpatch.js'
    }));
    document.head.appendChild(Object.assign(document.createElement('link'), {
      href: '/ext/griffpatch.css',
      rel: 'stylesheet'
    }));
  }
  ...
  var cloudHost = decodeURIComponent(urlOptionValue('cloud_host', 'dev-blocks-clouddata--powerbox1000.repl.co'));
  var username = urlOptionValue('username', 'devtime-user');
  ...
  var onVmInit = function onVmInit(vm) {
    // allow vm to force fullscreen
    vm.forceFullscreen = function(){
    // forces fullscreen and hides exit fullscreen button
    document.getElementsByClassName('stage-header_stage-button_4qxON')[2].click();
    document.getElementsByClassName('stage-header_stage-button_4qxON')[0].style.display = 'none';
    }
    //load speacial blocks
    vm.extensionManager.loadExtensionURL("https://cdn--powerbox1000.repl.co/DevBlocks/featuredblocks.js");
    vm.extensionManager.loadExtensionURL("https://cdn--powerbox1000.repl.co/DevBlocks/devblocksUtils.js");
    vm.extensionManager.loadExtensionURL("https://javaspeed.nmsderp.repl.co/ext/sockpuppet.js");
    vm.extensionManager.loadExtensionURL("https://javaspeed.nmsderp.repl.co/beta.js");
    vm.extensionManager.loadExtensionURL("https://javaspeed.nmsderp.repl.co/cool.js");
    vm.extensionManager.loadExtensionURL("https://javaspeed.nmsderp.repl.co/cloudmultiplayer.js");
